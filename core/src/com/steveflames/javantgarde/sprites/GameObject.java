...
public abstract class GameObject extends Sprite{
    ...
    public GameObject(String name, World world, TiledMap map, Rectangle bounds, boolean sensor) {
        ...
        bdef.position.set((bounds.getX() + bounds.getWidth()/2)/ com.steveflames.javantgarde.MyGdxGame.PPM, (bounds.getY() + bounds.getHeight()/2)/ com.steveflames.javantgarde.MyGdxGame.PPM);
        b2body = world.createBody(bdef);

        shape.setAsBox(bounds.getWidth()/ com.steveflames.javantgarde.MyGdxGame.PPM/2, bounds.getHeight()/ com.steveflames.javantgarde.MyGdxGame.PPM/2);
        fdef.shape = shape;
